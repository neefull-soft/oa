...
import com.mvc.base.common.exception.RRException;
...
import com.mvc.base.modules.sys.service.SysMenuService;
...
public class SysMenuController extends AbstractController {
	...
	public R save(@RequestBody SysMenuEntity menu){
		...
		if(menu.getParentId()==0||menu.getParentId()==null){
			...
			SysMenuEntity menuEntity = sysMenuService.selectById(menu.getParentId()) ;
